...
class Pagination
{
	 ...
	 * @since   1.5
	 */
	public function __construct($total, $limitstart, $limit, $prefix = '', Application $app = null)
	{
		// Value/type checking.
	...
	public function getPagesLinks()
	{
		...
		$chromePath = SOFTWAY_PATH_APP.'/html/pagination.php';
	...
	{
		Log::add('Pagination::set() is deprecated. Access the properties directly.', Log::WARNING, 'deprecated');
	...
	{
		Log::add('Pagination::get() is deprecated. Access the properties directly.', Log::WARNING, 'deprecated');
