 ...
 */
namespace SoftWay\CMS\Database\exporter;
 ...
 * @since       3.4
 */
class DatabaseExporterPdomysql extends DatabaseExporter
{
	/**
	 ...
	 *
	 * @return  DatabaseExporterPdomysql  Method supports chaining.
	 *
	 * @since   3.4
