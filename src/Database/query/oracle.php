 ...
 * @since  12.1
 */
class DatabaseQueryOracle extends DatabaseQueryPdo implements DatabaseQueryPreparable, DatabaseQueryLimitable
{
	/**
	 ...
	 *
	 * @return  DatabaseQueryOracle  Returns this object to allow chaining.
	 *
	 * @since   12.1
	 */
