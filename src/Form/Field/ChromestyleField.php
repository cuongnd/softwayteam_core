 ...
 * @since  3.0
 */
class ChromestyleField extends FormFieldGroupedList
{
	/**
	 * The form field type.
	 *
	...
	protected function getGroups()
	{
		...
		$tmp = '---' . SoftWayText::_('JLIB_FORM_VALUE_FROM_TEMPLATE') . '---';
		$groups[$tmp][] = \Html::_('select.option', '0', SoftWayText::_('JLIB_FORM_VALUE_INHERITED'));
