...
class MediaField extends FormField
{
	...
	public function getLayoutData()
	{
		...
		if ($this->value && file_exists(SOFT_WAY_CORE_PATH_ROOT . '/' . $this->value))
		{
		...
		elseif (file_exists(SOFT_WAY_CORE_PATH_ROOT . '/' . ComponentHelper::getParams('com_media')->get('image_path', 'images') . '/' . $this->directory))
		{
