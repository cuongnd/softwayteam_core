 ...
 * @since  1.7.0
 */
class FormFieldPhoneNumber extends FormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  3.7
	 */
	protected $layout = 'WooBooking.form.field.phonenumber';
	...
	protected function getInput()
	{
		if ($this->element['useglobal'])
		{
			...
			$params = NBAppHelper::getParams($component);
			...
			{
				$value = NBAppHelper::getParams('com_menus')->get($this->fieldname);
			}
	...
	protected function getLayoutData()
	{
		...
		$extraData = array(
			...
			'dirname'   => $dirname,
			'options'   => $options,
			'field_name_country_code'   => $this->element['field_name_country_code'],
			'default_country_code'   => $this->element['default_country_code'],
		);
