 ...
 * @since  1.7.0
 */
class FormFieldOpenDate extends FormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  3.7
	 */
	protected $layout = 'WooBooking.form.field.opendate';
	...
	protected function getLayoutData()
	{
		...
		$extraData = array(
			...
			'name_open_date'   => $this->element['name_open_date'],
			'inputmode' => $inputmode,
			'dirname'   => $dirname,
			'options'   => $options,
		);
