...
class FormFieldMap extends FormField
{
	 ...
	 * @since  3.7
	 */
	protected $layout = 'WooBooking.form.field.map';
	...
	protected function getLayoutData()
	{
        ...
        $extraData = array(
			...
			'dirname'   => $dirname,
			'options'   => $options,
			'field_published'   => $this->element['field_published'],
			'listen_onchange_address_name'   => $this->element['listen_onchange_address_name']? $this->element['listen_onchange_address_name']:'address',
		);
