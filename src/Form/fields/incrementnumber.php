 ...
 * @since  1.7.0
 */
class FormFieldIncrementNumber extends FormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  1.7.0
	 */
	protected $type = 'IncrementNumber';
	 ...
	 * @since  3.7
	 */
	protected $layout = 'WooBooking.form.field.incrementnumber';
	...
	protected function getLayoutData()
	{
		...
		$extraData = array(
			...
			'name_close_date'   => $this->element['name_close_date'],
			'inputmode' => $inputmode,
			'dirname'   => $dirname,
            'max'   => $this->max,
            'min'   => $this->min,
