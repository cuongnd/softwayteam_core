 ...
 * @since  1.7.0
 */
class FormFieldSelectFolderPath extends FormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  1.7.0
	 */
	protected $type = 'selectfolderpath';
	 ...
	 * @since  3.7
	 */
	protected $layout = 'WooBooking.form.field.selectfolderpath';
	...
	protected function getLayoutData()
	{
		...
		$extraData = array(
			...
			'dirname'   => $dirname,
			'options'   => $options,
			'field_name_out_put_list_data'   => $this->element['field_name_out_put_list_data'],
		);
