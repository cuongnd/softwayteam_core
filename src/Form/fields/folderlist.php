 ...
 * @since  1.7.0
 */
class FormFieldFolderList extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	...
	protected function getOptions()
	{
		...
		if (!$this->hideNone)
		{
			$options[] = Html::_('select.option', '-1', SoftWayText::alt('JOPTION_DO_NOT_USE', preg_replace('/[^a-zA-Z0-9_\-]/', '_', $this->fieldname)));
		}

		if (!$this->hideDefault)
		{
			$options[] = Html::_('select.option', '', SoftWayText::alt('JOPTION_USE_DEFAULT', preg_replace('/[^a-zA-Z0-9_\-]/', '_', $this->fieldname)));
		}
