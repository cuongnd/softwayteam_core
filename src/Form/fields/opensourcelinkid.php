 ...
 * @since  1.7.0
 */
class FormFieldOpenSourceLinkId extends FormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  1.7.0
	 */
	protected $type = 'opensourcelinkid';
	 ...
	 * @since  3.7
	 */
	protected $layout = 'WooBooking.form.field.opensourcelinkid';
	...
	protected function getLayoutData()
	{
		...
		return array_merge($data, $opensourcelinkidData);
	}
}
