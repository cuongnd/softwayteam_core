 ...
 * @since  1.7.0
 */
class FormFieldRecurring extends FormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  3.7
	 */
	protected $layout = 'WooBooking.form.field.recurring';
	...
	protected function getLayoutData()
	{
        ...
        $extraData = array(
			...
			'inputmode' => $inputmode,
			'dirname'   => $dirname,
			'name_recurring_repeat'   => $this->element['name_recurring_repeat'],
			'name_recurring_until'   => $this->element['name_recurring_until'],
			'options'   => $options,
		);
