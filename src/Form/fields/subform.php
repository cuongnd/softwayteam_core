 ...
 * 		layout="softwaycore.form.field.subform.repeatable-table" groupByFieldset="false" component="com_example" client="site"
	...
	public function __set($name, $value)
	{
		switch ($name)
		{
			case 'formsource':
				...
				{
					$this->formsource = JPath::clean(SOFT_WAY_CORE_PATH_ROOT . '/' . $this->formsource);
				}
