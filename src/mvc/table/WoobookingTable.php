...
abstract class WoobookingTable extends CMSObject
{
	...
	public static function getInstance($type, $prefix = 'JTable', $config = array())
	{
		...
		if (!class_exists($tableClass))
		{
			...
			if (!class_exists($tableClass))
			{
				...
				* For more info see https://github.com/softwaycore/softwaycore-cms/issues/11570
				*/
	...
	public function bind($src, $ignore = array())
	{
        ...
        $is_array=is_array($src);
/*        echo "type:".gettype($is_array);
        echo "<br/>";
        echo "value:".$is_array;*/
	 ...
	 * built in \softwaycore functions.
	 *
