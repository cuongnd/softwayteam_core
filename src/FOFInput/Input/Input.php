<?php
/**
 * Part of the softwaycore Framework Input Package
 *
...
class Input implements \Serializable, \Countable
{
     ...
     *
     * @see     \softwaycore\Filter\InputFilter::clean()
     * @since   1.0
     */
     ...
     *                              but filtered using the default case in FOFInput::clean.
