...
class Document
{
	...
	public function addLessStyleSheet($url, $options = array(), $attribs = array())
	{
		...
		$this->_lessStyleSheets[$url] = isset($this->_lessStyleSheets[$url]) ? array_replace($this->_lessStyleSheets[$url], $attribs) : $attribs;

		if (isset($this->lessStyleSheets[$url]['options']))
		{
			$this->_lessStyleSheets[$url]['options'] = array_replace($this->_lessStyleSheets[$url]['options'], $options);
		}
		else
		{
			$this->_lessStyleSheets[$url]['options'] = $options;
		}
	...
	public function getLessStyleSheets()
	{
		return $this->_lessStyleSheets;
	}
