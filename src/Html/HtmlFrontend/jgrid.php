...
abstract class HtmlFrontendJGrid
{
	...
	public static function published($value, $i, $prefix = '', $enabled = true, $checkbox = 'cb', $publish_up = null, $publish_down = null)
	{
		...
		if ($publish_up || $publish_down)
		{
			...
			if ($publish_up)
			{
				$tips[] = SoftWayText::sprintf('JLIB_HTML_PUBLISHED_START', HtmlFrontend::_('date', $publish_up, SoftWayText::_('DATE_FORMAT_LC5'), 'UTC'));
			}

			if ($publish_down)
			{
				$tips[] = SoftWayText::sprintf('JLIB_HTML_PUBLISHED_FINISHED', HtmlFrontend::_('date', $publish_down, SoftWayText::_('DATE_FORMAT_LC5'), 'UTC'));
			}
	...
	public static function checkedout($i, $editorName, $time, $prefix = '', $enabled = false, $checkbox = 'cb')
	{
		...
		$text = $editorName . '<br />' . HtmlFrontend::_('date', $time, SoftWayText::_('DATE_FORMAT_LC')) . '<br />' . HtmlFrontend::_('date', $time, 'H:i');
		$active_title = HtmlFrontend::_('tooltipText', SoftWayText::_('JLIB_HTML_CHECKIN'), $text, 0);
		$inactive_title = HtmlFrontend::_('tooltipText', SoftWayText::_('JLIB_HTML_CHECKED_OUT'), $text, 0);
