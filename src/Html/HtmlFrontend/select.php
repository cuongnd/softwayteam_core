...
abstract class HtmlFrontendSelect
{
	...
	{
		$arr = array(HtmlFrontend::_('select.option', '0', SoftWayText::_($no)), HtmlFrontend::_('select.option', '1', SoftWayText::_($yes)));
	...
	{
		Log::add('JHtmlSelect::optgroup() is deprecated, use JHtmlSelect::groupedList() instead.', Log::WARNING, 'deprecated');
