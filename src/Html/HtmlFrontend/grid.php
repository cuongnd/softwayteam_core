 ...
 * @since  1.5
 */
abstract class HtmlFrontendGrid
{
	/**
	...
	public static function boolean($i, $value, $taskOn = null, $taskOff = null)
	{
		...
		$title = HtmlFrontend::_('tooltipText', $title, SoftWayText::_('JGLOBAL_CLICK_TO_TOGGLE_STATE'), 0);
	...
	protected static function _checkedOut(&$row, $overlib = true)
	{
		...
		if ($overlib)
		{
			...
			$date = HtmlFrontend::_('date', $row->checked_out_time, SoftWayText::_('DATE_FORMAT_LC1'));
