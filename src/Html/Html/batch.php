...
abstract class HtmlBatch
{
	 ...
	 * @since       1.7
	 *
	 * @deprecated  4.0 instead of Html::_('batch.access'); use JLayoutHelper::render('SoftWay.html.batch.access', array());
	 */
	 ...
	 * @since       1.7
	 *
	 * @deprecated  4.0 instead of Html::_('batch.item'); use JLayoutHelper::render('SoftWay.html.batch.item', array('extension' => 'com_XXX'));
	 */
	 ...
	 * @since       2.5
	 *
	 * @deprecated  4.0 instead of Html::_('batch.language'); use JLayoutHelper::render('SoftWay.html.batch.language', array());
	 */
	 ...
	 * @since       2.5
	 *
	 * @deprecated  4.0 instead of Html::_('batch.user'); use JLayoutHelper::render('SoftWay.html.batch.user', array());
	 */
	 ...
	 * @since       3.1
	 *
	 * @deprecated  4.0 instead of Html::_('batch.tag'); use JLayoutHelper::render('SoftWay.html.batch.tag', array());
	 */
