...
class Session implements \IteratorAggregate
{
	 ...
	 *
	 * @var  \softwaycore\Registry\Registry
	 */
	protected $data;
	 ...
	 * @param   \SessionHandlerInterface  $handlerInterface  The session handler
	 *
	 * @since   1.7.0
	 */
	...
	public static function getInstance($store, $options)
	{
		...
		{
		    $outsource=Factory::getOpenSource();
			self::$instance = new Session();
			self::$instance->open_source_session = $outsource->getSession();
		}
	 ...
	 *
	 * @return  \softwaycore\Registry\Registry
	 */
	...
	public static function getStores()
	{
		...
		$iterator = new \DirectoryIterator(JPATH_LIBRARIES . '/softwaycore/session/storage');
	...
	protected function _start()
	{
		...
		if (isset($_SESSION['softwaycore']) && !empty($_SESSION['softwaycore']))
		{
			$data = $_SESSION['softwaycore'];
