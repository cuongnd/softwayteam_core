...
?><div class="hikashop_payuindia_end" id="hikashop_payuindia_end">
	<span id="hikashop_payuindia_end_message" class="hikashop_payuindia_end_message">
		<?php echo WoobookingText::sprintf('PLEASE_WAIT_BEFORE_REDIRECTION_TO_X', $this->payment_name).'<br/><span id="hikashop_payuindia_button_message">'. WoobookingText::_('CLICK_ON_BUTTON_IF_NOT_REDIRECTED').'</span>';?>
	</span>
	...
	<form id="hikashop_payuindia_form" name="hikashop_payuindia_form" action="<?php echo $this->payment_params->url;?>" method="post">
		<div id="hikashop_payuindia_end_image" class="hikashop_payuindia_end_image">
			<input id="hikashop_payuindia_button" type="submit" class="btn btn-primary" value="<?php echo WoobookingText::_('PAY_NOW');?>" name="" alt="<?php echo WoobookingText::_('PAY_NOW');?>" />
		</div>
<?php
