...
<fieldset><legend><?php echo WoobookingText::_('STRIPE_FORM').' : '; ?></legend>
	...
	<form action="<?php echo $this->notifyurl; ?>" method="POST" id="payment-form">
		<table width="70%" style="margin:auto; margin-bottom:10px;">
			...
			<tr style="margin-bottom:5px;">
				<td style="text-align:right"><label><?php echo WoobookingText::_('CREDIT_CARD_NUMBER').' : '; ?></label></td>
			...
			<tr style="margin-bottom:5px;">
				<td style="text-align:right"><label><?php
					echo WoobookingText::_('EXPIRATION_DATE') . ' ('.WoobookingText::_('MM').'/'.WoobookingText::_('YY').WoobookingText::_('YY').') : ';
				?></label></td>
