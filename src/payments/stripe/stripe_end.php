...
<fieldset><legend><?php echo SoftWayText::_('STRIPE_FORM').' : '; ?></legend>
	...
	<form action="<?php echo $this->notifyurl; ?>" method="POST" id="payment-form">
		<table width="70%" style="margin:auto; margin-bottom:10px;">
			...
			<tr style="margin-bottom:5px;">
				<td style="text-align:right"><label><?php echo SoftWayText::_('CREDIT_CARD_NUMBER').' : '; ?></label></td>
			...
			<tr style="margin-bottom:5px;">
				<td style="text-align:right"><label><?php
					echo Html::tooltip(SoftWayText::_('CVC_TOOLTIP_TEXT').' : ', SoftWayText::_('CVC_TOOLTIP_TITLE'), '', SoftWayText::_('CARD_VALIDATION_CODE'));
				?></label></td>
				<td><input style="text-align: center;" value="" type="text" maxlength="4" size="4" data-stripe="cvc"></td>
			</tr>
			<tr style="margin-bottom:5px;">
				<td style="text-align:right"><label><?php
					echo SoftWayText::_('EXPIRATION_DATE') . ' ('.SoftWayText::_('MM').'/'.SoftWayText::_('YY').SoftWayText::_('YY').') : ';
				?></label></td>
