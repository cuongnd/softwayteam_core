...
<div class="hikashop_epay_end" id="hikashop_epay_end">
	...
	<div id="hikashop_epay_end_image" class="hikashop_epay_end_image">
		<input id="hikashop_epay_button" type="button" onClick="paymentwindow.open();" value="<?php echo WoobookingText::_('PAY_NOW');?>" name="" alt="<?php echo WoobookingText::_('PAY_NOW');?>" />
	</div>
	<?php
