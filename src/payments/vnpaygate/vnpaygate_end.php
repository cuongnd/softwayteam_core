...
?><div class="hikashop_paygate_end" id="hikashop_paygate_end">
	...
	<br/>
	<form id="hikashop_paygate_form" name="hikashop_paygate_form" action="<?php echo $this->payment_params->payment_url;?>" method="post">
		<div id="hikashop_paygate_end_image" class="hikashop_paygate_end_image">
			<input id="hikashop_paygate_button" class="btn btn-primary" type="submit" value="<?php echo WoobookingText::_('PAY_NOW');?>" name="" alt="<?php echo WoobookingText::_('PAY_NOW');?>" />
		</div>
		<?php
