...
class DelegatingPsrLogger extends AbstractLogger
{
	...
	/**
	 * Mapping array to map a PSR-3 level to a softwaycore priority.
	 *
	 * @var    array
	 * @since  3.8.0
	 */
	...
	public function log($level, $message, array $context = array())
	{
		...
		// Map the level to softwaycore's priority
		...
		// softwaycore's logging API will only process a string or a LogEntry object, if $message is an object without __toString() we can't use it
