 ...
 * for the softwaycore Platform to access and manipulate a URI.  Second it obtains the URI of
 * the current executing script from the server regardless of server.
 *
 * @since  1.7.0
 */
class NBUri extends Uri
{
	/**
	 ...
	 *
	 * @since       1.7.0
	 * @deprecated  4.0  Use {@link \softwaycore\Uri\Uri::setPath()}
	 ...
	 *
	 * @since       1.7.0
	 * @deprecated  4.0   Use {@link \softwaycore\Uri\Uri::cleanPath()} instead
	 */
