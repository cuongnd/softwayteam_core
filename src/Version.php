...
final class Version
{
	 ...
	 * @since  3.5
	 */
	const URL = '<a href="https://www.softwaycore.org">softwaycore!</a> is Free Software released under the GNU General Public License.';
	...
	public function __get($name)
	{
		if (defined("JVersion::$name"))
		{
			...
			return constant("\\softwaycore\\CMS\\Version::$name");
		}
	...
	/**
	 * Compares two a "PHP standardized" version number against the current softwaycore version.
	 *
	 * @param   string  $minimum  The minimum version of the softwaycore which is compatible.
	 *
	...
	/**
	 * Gets a "PHP standardized" version string for the current softwaycore.
	 *
	...
	/**
	 * Gets a version string for the current softwaycore with all release information.
	 *
	...
	/**
	 * Gets a media version which is used to append to softwaycore core media files.
	 *
	...
	public function getMediaVersion()
	{
		...
		{
			// Get the softwaycore library params
			$params = LibraryHelper::getParams('softwaycore');
	...
	/**
	 * Sets the media version which is used to append to softwaycore core media files.
	 *
	...
	public function setMediaVersion($mediaVersion)
	{
		...
		if (!empty($mediaVersion))
		{
			...
			LibraryHelper::saveParams('softwaycore', $params);
		}
