<?php
/**
 * Part of the softwaycore Framework Utilities Package
 *
 ...
 *
 * This class is adapted from the `FOFUtilsIp` class distributed with the softwaycore! CMS as part of the FOF library by Akeeba Ltd.
