...
class Utility
{
    ...
    public static function get_short_file_by_path($file_path){
        ...
        return str_replace(SOFT_WAY_CORE_PATH_ROOT.'/','',$file_path);
    }
    ...
    public static function get_user_debug(){
        require_once SOFT_WAY_CORE_PATH_ROOT.DS."components/com_tools/helpers/tools.php";
    ...
    {
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Minify.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/JS.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Exception.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/path-converter-master/src/ConverterInterface.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/path-converter-master/src/Converter.php';
        $minifier = new Minify\JS(SOFT_WAY_CORE_PATH_ROOT . DS . $file_js);
        $js_compress_content=$minifier->minify();
        JFile::write(SOFT_WAY_CORE_PATH_ROOT . DS . $compress_file, $js_compress_content);
    }
    public static function closure_compiler_js_by_url_js($js_file, $compress_file)
    {
        ...
        if (strpos($output1, 'api quota exceeded') !== false) {
            ...
            echo "</br>";
            JFile::write(SOFT_WAY_CORE_PATH_ROOT.DS.$compress_file, $output);
        }
        echo "<hr/>";
    }
    public static function write_compress_css($file_css, $compress_css_file)
    {
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Minify.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Exception.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Exceptions/BasicException.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Exceptions/FileImportException.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/CSS.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Exception.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/path-converter-master/src/ConverterInterface.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/path-converter-master/src/Converter.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/path-converter-master/src/NoConverter.php';
    ...
    public static function write_compress_css_by_content($css_content, $compress_css_file)
    {
        ...
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Exception.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Exceptions/BasicException.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Exceptions/IOException.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Exceptions/BasicException.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Exceptions/FileImportException.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/CSS.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-master/src/Exception.php';
    ...
    {
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-2.x/min/lib/Minify/CommentPreserver.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-2.x/min/lib/Minify/HTML.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-2.x/min/lib/Minify/CSS.php';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/minifyjscss/minify-2.x/min/lib/JSMin.php';
    ...
    {
        require_once SOFT_WAY_CORE_PATH_ROOT.DS.'libraries/less.php_1.7.0.10/less.php/Less.php';
        require_once SOFT_WAY_CORE_PATH_ROOT.DS.'libraries/CSS-Parser-master/parser.php';
        ...
        $css_parser->parse();
        require_once SOFT_WAY_CORE_PATH_ROOT.DS.'libraries/softwaycore/html/style.php';
    ...
    {
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/softwaycore/image-master/src/Image.php';
        $source_info = pathinfo($source);
        $image = new Image();
        $temp_image_path = "/tmp/" . $source_info['basename'];
        $image->loadFile($source);
        $image->crop($width, $height);
        $image->toFile(SOFT_WAY_CORE_PATH_ROOT . $temp_image_path);
    ...
    {
        $source = SOFT_WAY_CORE_PATH_ROOT . DS . 'images/com_hikashop/upload/thumbnail_25x25/thoitrang_phukien-1336232718.png';
        require_once SOFT_WAY_CORE_PATH_ROOT . DS . 'libraries/softwaycore/image-master/src/Image.php';
        $source_info = pathinfo($source);
        $image = new Image();
        $temp_image_path = "/tmp/" . $source_info['basename'];
        ...
        $image->toFile(SOFT_WAY_CORE_PATH_ROOT . $temp_image_path, IMAGETYPE_PNG, array('options' => 0));
        return $temp_image_path;
    }
    ...
    public function get_class_icon_font()
    {
        ...
        foreach ($iconFiles as $file) {
            $content .= JFile::read(SOFT_WAY_CORE_PATH_ROOT . '/' . $file);
        }
        $icon_class = array();
